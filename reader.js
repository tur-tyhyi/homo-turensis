(function () {
  ...
  fetch("HOMO-TURENSIS.md")
    ...
    .catch(function () {
      bookEl.innerHTML =
        '<p class="book-error">The book could not be loaded. Open <a href="HOMO-TURENSIS.md">HOMO-TURENSIS.md</a>.</p>';
    });
})();
